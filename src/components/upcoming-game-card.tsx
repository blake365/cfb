...
export function UpcomingGameCard({ game }) {
	...
	return (
		<div className='relative w-full max-w-2xl px-2'>
			<Card className='w-full border-slate-800 hover:shadow-lg px-4 py-2 bg-muted'>
				<CardContent className=''>
					<div className='flex justify-center items-center'>
						...
						<div className='text-center flex flex-row items-center justify-center space-x-10'>
